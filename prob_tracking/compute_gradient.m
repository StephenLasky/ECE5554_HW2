function im = compute_gradient( im, sigma, direction, theta, a )
% IMPLEMENTS gauss derivative filter
% That is, takes an inpute image, and computes the gradient of the given direction and angle

% construct the filter 
filter = create_gradient_filter(direction, sigma, theta, a);
